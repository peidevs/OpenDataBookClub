...
if (args.size() < 3) {
    println "Usage: groovy OD31_Ring_Generator.groovy inCsv templateHtml outHtml"
    System.exit(-1)
}
...
def dataCsvURL = '"https://raw.githubusercontent.com/peidevs/OpenDataBookClub/master/data/province/finance/OD31.transform.csv"'
def dataFilter = buildFilter(fiscalYears)
def dataPredicateField = '"Fiscal Year"' 
def dataMeasureField = '"Amount (000' + "'" + 's)"'
def dataSeriesField = '"Department or Agency"'
